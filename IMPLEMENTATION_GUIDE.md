...
This guide translates [RIDM 15](RIDM.MD) into software boundaries, data
...
| RIDM 15 Conformant | Action Runtime plus reopening, completion certificates, privacy controls, claim-type-conditioned calibration audit with weakest-link banding and item-rigor caps, item provenance and rigor classification with author-competence estimation, derivation-first sequencing, absence and enrichment audits, contrast-typed recall, flagged-observable observation, evaluation metrics, and conformance tests |

Do not describe a partial implementation as RIDM 15 conformant. State the
...
Claim RIDM 15 conformance only after every required capability and acceptance
case passes.
