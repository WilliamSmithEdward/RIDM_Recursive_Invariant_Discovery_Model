# Framework Lessons - Sprint 01 (Q000001 to Q000010)
...
## L1. Closed-world validation rung (Q000001)
...
## L2. Recall is evidence with a default type (Q000001)
...
named upgrade paths: derivation, anchor agreement, or external observation. In Q000001 the only
...
## L3. Anchor tests deserve standing (Q000001)
...
and Q000001. The specification never names this device.

## L4. Internal route conflicts need the external conflict rules (Q000002)
...
## L5. Adversarial calibration of the task itself (Q000002)
...
## L6. Literal contract precedence in forced choice (Q000003, incorrect answer)
...
must not override a result derived from the stated criterion. In Q000003 an inferred
author-intent claim overrode a derived dominance result and produced the wrong commitment.

## L7. Trap-depth iteration (Q000003, incorrect answer)
...
## L8. Claim-type precedence must bind at final selection (Q000003, incorrect answer)
...
stronger-typed support. In Q000003 the inversion (inferred over derived) happened exactly and
only at the decision step.

## L9. Coherence gate on interpretations (Q000004, incorrect answer)
...
## L10. State changes propagate in pure reasoning too (Q000004, incorrect answer)
...
## L11. Availability is the weakest support tier (Q000004, incorrect answer)
...
## L12. Verify the verifier (Q000005, defective official answer)
...
Q000005 the official rationale contained several checkable arithmetic impossibilities;
capitulating to it would have corrupted the model.

## L13. Surprise decomposition before self-revision (Q000005)
...
## L14. Candidate-set coverage before ranking (Q000006, incorrect answer)
...
## L15. Per-band confidence calibration (Q000006 and cumulative)
...
## L16. The task text is an evidence source (Q000008, incorrect answer)
...
## L17. Criterion-information mismatch (Q000010, incorrect per under-determined key)
